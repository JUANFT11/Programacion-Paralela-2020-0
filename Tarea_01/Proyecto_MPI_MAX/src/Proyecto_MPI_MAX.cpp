 ...
 */
    ...
    /**
      * Ilustra cómo usar una operación de reducción máxima.
      * Esta aplicación consiste en una reducción máxima; cada proceso MPI
    ...
    int main(int argc, char* argv[])
    {
        ...
        // Obtenga el número de procesos y verifique que solo se usen 4.
        int size;
